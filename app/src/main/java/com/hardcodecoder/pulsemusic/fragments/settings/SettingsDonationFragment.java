...
public class SettingsDonationFragment extends SettingsBaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.bmc_btn).setOnClickListener(v -> openLink("https://www.buymeacoffee.com/"));
        view.findViewById(R.id.pp_btn).setOnClickListener(v -> openLink("https://paypal.me/"));
    }
